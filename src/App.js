...
import PageCommande from "./DashboardRestaurateur/commandes/pageDeLaCommande/PageCommande";
      ...
      <AuthProvider>
          <BrowserRouter>
              ...
              <Route exact path="/" component={Home}/>
                  ...
                  <Route exact path="/dashboard/:id/commandes/all" render={props => <Dashboard {...props} type={10} />} />
                  <Route exact path="/dashboard/:id/commandes/:idCommande" render={props => <PageCommande {...props} />} />
