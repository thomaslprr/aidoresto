    ...
    return (<>
        ...
        <Typography variant="h6" gutterBottom>
            ...
            Prestations et Services
             ...
             http://www.helporesto.fr met à disposition des Clients :
            ...
            données personnelles susceptibles d’être détenues par http://www.helporesto.fr pour la gestion de
            votre compte, de la gestion de la relation client et à des fins d’analyses et de statistiques.
                    <Typography variant="h6" gutterBottom>
        ...
        Le responsable publication est une personne physique ou une personne morale.
            ...
            Brieux DORLEANS – contact@helporesto.fr
            <br/>
        ...
        réutiliser, céder ou exploiter pour son propre compte tout ou partie des éléments ou travaux du Site.<br/>
        L’utilisation du site http://www.helporesto.fr implique l’acceptation pleine et entière des conditions
        générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées
        ou complétées à tout moment, les utilisateurs du site http://www.helporesto.fr sont donc invités à les
        consulter de manière régulière.<br/>
        Ce site internet est normalement accessible à tout moment aux utilisateurs. Une interruption pour
        raison de maintenance technique peut être toutefois décidée par http://www.helporesto.fr, qui
        s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de l’intervention.
        Le site web http://www.helporesto.fr est mis à jour régulièrement
        par http://www.helporesto.fr responsable. De la même façon, les mentions légales peuvent être
        ...
        Le site internet http://www.helporesto.fr a pour objet de fournir une information concernant
        l’ensemble des activités de la société. http://www.helporesto.fr s’efforce de fournir sur le
        site http://www.helporesto.fr des informations aussi précises que possible. Toutefois, il ne pourra être
        tenu responsable des oublis, des inexactitudes et des carences dans la mise à jour, qu’elles soient de
        son fait ou du fait des tiers partenaires qui lui fournissent ces informations.<br/>
        Toutes les informations indiquées sur le site http://www.helporesto.fr sont données à titre indicatif, et
        sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le
        site http://www.helporesto.fr ne sont pas exhaustifs. Ils sont donnés sous réserve de modifications
        ...
        Le site http://www.helporesto.fr est hébergé chez un prestataire sur le territoire de l’Union Européenne
        conformément aux dispositions du Règlement Général sur la Protection des Données (RGPD : n° 2016-
        679)<br/>
        ...
        infrastructures ou si les Prestations et Services génèrent un trafic réputé anormal.<br/>
        http://www.helporesto.fr et l’hébergeur ne pourront être tenus responsables en cas de
        ...
        http://www.helporesto.fr est propriétaire des droits de propriété intellectuelle et détient les droits
        ...
        utilisé, est interdite, sauf autorisation écrite préalable de : http://www.helporesto.fr.<br/>
        ...
        http://www.helporesto.fr agit en tant qu’éditeur du site. http://www.helporesto.fr est responsable de
        la qualité et de la véracité du contenu qu’il publie.<br/>
        http://www.helporesto.fr ne pourra être tenu responsable des dommages directs et indirects causés au
        matériel de l’utilisateur, lors de l’accès au site internet http://www.helporesto.fr, et résultant soit de
        ...
        http://www.helporesto.fr ne pourra également être tenu responsable des dommages indirects (tels par
        exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du
        site http://www.helporesto.fr. Des espaces interactifs (possibilité de poser des questions dans l’espace
        contact) sont à la disposition des utilisateurs. http://www.helporesto.fr se réserve le droit de
        ...
        données. Le cas échéant, http://www.helporesto.fr se réserve également la possibilité de mettre en
        ...
        En tant que responsable du traitement des données qu’il collecte, http://www.helporesto.fr s’engage à
        respecter le cadre des dispositions légales en vigueur. Il lui appartient notamment au Client d’établir
        les finalités de ses traitements de données, de fournir à ses prospects et clients, à partir de la collecte
        de leurs consentements, une information complète sur le traitement de leurs données personnelles et
        de maintenir un registre des traitements conforme à la réalité. <br/>
        Chaque fois que http://www.helporesto.fr traite des Données Personnelles, http://www.helporesto.fr prend toutes
        ...
        http://www.helporesto.fr est susceptible de traiter tout ou partie des données :<br/>
        ...
        •pour mener des enquêtes de satisfaction facultatives sur http://www.helporesto.fr : adresse email<br/>
        ...
        de http://www.helporesto.fr disposent des droits suivants :<br/>
        ...
        qui http://www.helporesto.fr devra communiquer (ou non) ses données à un tiers qu’ils aura
        préalablement désigné <br/>
        Dès que http://www.helporesto.fr a connaissance du décès d’un Utilisateur et à défaut d’instructions
        de sa part, http://www.helporesto.fr s’engage à détruire ses données, sauf si leur conservation s’avère
        nécessaire à des fins probatoires ou pour répondre à une obligation légale.<br/><br/>
        Si l’Utilisateur souhaite savoir comment http://www.helporesto.fr utilise ses Données Personnelles,
        demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut
        contacter http://www.helporesto.fr par écrit à l’adresse suivante : <br/>
        contact@helporesto.fr <br/>
        Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait
        que http://www.helporesto.fr corrige, mette à jour ou supprime, en s’identifiant précisément avec une
        copie d’une pièce d’identité (carte d’identité ou passeport).<br/>
        ...
        à la condition qu’il présentent les garanties suffisantes au regard des exigences du Règlement Général
        sur la Protection des Données (RGPD : n° 2016-679). <br/>
        http://www.helporesto.fr s’engage à prendre toutes les précautions nécessaires afin de préserver la
        ...
        Client est portée à la connaissance de http://www.helporesto.fr, celle-ci devra dans les meilleurs délais
        informer le Client et lui communiquer les mesures de corrections prises.
        <br/>
        Par ailleurs http://www.helporesto.fr ne collecte aucune « données sensibles ».
        <br/>
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales
        de http://www.helporesto.fr et des sous-traitants (prestataires de services), exclusivement afin de
        réaliser les finalités de la présente politique.<br/>
        Dans la limite de leurs attributions respectives et pour les finalités rappelées ci-dessus, les principales
        personnes susceptibles d’avoir accès aux données des Utilisateurs de http://www.helporesto.fr sont
        ...
        aider à respecter leurs propres obligations réglementaires en matière de reporting. <br/>
        Aucune information personnelle de l'utilisateur du site http://www.helporesto.fr n'est publiée à l'insu
        ...
        Santé, http://www.helporesto.fr utilise des réseaux protégés par des dispositifs standards tels que par
        pare-feu, la pseudonymisation, l’encryption et mot de passe. <br/>
        Lors du traitement des Données Personnelles, http://www.helporesto.frprend toutes les mesures
        ...
        Internet de l’Utilisateur, le système d’exploitation de l’Utilisateur, ainsi que la date et l’heure d’accès.
        Les Cookies ne risquent en aucun cas d’endommager le terminal de l’utilisateur. <br/><br/>
        http://www.helporesto.fr est susceptible de traiter les informations de l’Utilisateur concernant sa visite
        du Site, telles que les pages consultées, les recherches effectuées. Ces informations permettent
        à http://www.helporesto.fr d’améliorer le contenu du Site, de la navigation de l’Utilisateur.<br/><br/>
        ...
        lorsque http://www.helporesto.fr ou l’un de ses prestataires ne peut pas reconnaître, à des fins de
        compatibilité technique, le type de navigateur utilisé par le terminal, les paramètres de langue et
        d’affichage ou le pays depuis lequel le terminal semble connecté à Internet.<br/><br/>
        Le cas échéant, http://www.helporesto.fr décline toute responsabilité pour les conséquences liées au
        fonctionnement dégradé du Site et des services éventuellement proposés
        par http://www.helporesto.fr, résultant (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité
        pour http://www.helporesto.fr d’enregistrer ou de consulter les Cookies nécessaires à leur
        fonctionnement du fait du choix de l’Utilisateur. Pour la gestion des Cookies et des choix de
        l’Utilisateur, la configuration de chaque navigateur est différente. Elle est décrite dans le menu d’aide
